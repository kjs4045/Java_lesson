...
public class C46_ArrayList {
	...
	public static void main(String[] args) {
		...
		ArrayList<Integer> list = new ArrayList<>();
					...
					//데이터 타입은 모두 참조형타입만 입니다. 기본형은 래퍼클래스를 사용합니다.
					//<T>,<E> 는 제너릭 타입이라고 부릅니다.
		...
		System.out.println("1. 첫번째 ArrayList<Interger> 출력");
		...
		System.out.println("\n3. 특정 위치에 데이터 추가");
		list.add(1,23);         //(인데스위치, 추가될 값) 단, 인덱스 위치는 리스트의 크기 미만 값.
		...
		for(i=0;i<name_list.size();i++) {
			...
			//'신비' 요소가 여러개일대 리스는 lastIndexOf 메소드로 마지막 일치 요소를 찾을 수 있습니다.
