...
public class C35_GlobalVar {
	/* 
	 * [변수가 선언된 위치로 구분]
	 * 지역변수(local variable) : 메소드, for,if,while 등등 { } 에서 선언된 변수사용 못함.
...
//	    methodA();     오류: static이 아닌 메소드
	...
	public static void methodB( ) {
		...
		System.out.println("num = " + num );  //99
		System.out.println("num = "  + C35_GlobalVar.num);        //Interger.BYTES와 같은 형태.
          //전역변수로 선언된 message. static 일때는 클래스이름. 변수명 /static이 아닐때는 this.변수명
