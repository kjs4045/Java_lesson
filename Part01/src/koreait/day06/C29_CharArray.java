...
//char 배열의 특징 및 문자열과의 연관된 내용 파악하기!
	...
	//char 배열의 선언
		...
		System.out.println("carr1 : " + Arrays.toString(carr1)); //tostring의 주체는 arrays클래스
		System.out.println("carr2 : " + Arrays.toString(carr2));
		//공백처럼 나오지만  값0에 대한문자는 빈칸
		System.out.println("carr1 배열 길이(크기) : " + carr1.length);
		System.out.println("carr2 배열 길이(크기) : " + carr2.length);
	
	    System.out.println("carr1 배열 3번째 데이터의 값(문자): "  + (int)carr1[2]);//109
	    System.out.println("carr2 배열 3번째 데이터의 값(문자): "  + (int)carr2[2]);//0
	    ...
	    System.out.println("1. for문으로 출력");
	     ...
	     System.out.println("n[[[[ char 배열 테스트 - 3 ]]]]");
	     System.out.println("4. 문자열을 배열로 변경");
	     
	     
//	     carr2="hello hi goodbye";           //char배열에 바로 문자열 대입은오류.
	     carr2="hello hi goodbye".toCharArray();     //String 문자열 객체를 char 배열로 전환
	     ...
	     System.out.println(carr2);
	     System.out.println("carr2.length : " + carr2.length);  //27. 그러면 배열의 크기가 커진다.
