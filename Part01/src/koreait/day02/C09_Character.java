...
public class C09_Character {
	...
	public static void main(String[] args) {
	    ...
	    System.out.printf("c1= %d\n",(int)c1); //¿À·ù: char ÇüÀº %d °¡ ¾Æ´Õ´Ï´Ù.
	    System.out.printf("c2= %d\n",(int)c2);
	    
	     c1 = (char)(c1+1); //µ¡¼À ¿¬»ê °¡´É. ¿¬»ê°á°ú ´ëÀÔÇÒ‹š´Â casting ÇÊ¿ä
	     System.out.println("c1 = " + c1);
	     
	     c1++;              //++¿¬»êÀº c1= c1+1 , char Çü¿¡¼­´Â castingÀÌ ÇÊ¿ä¾ø½À´Ï´Ù.(INT ¸®ÅÍ·²»ç¿ëÇÑ °è»êÀÌ ¾Æ´Ï±â¶§¹®ÀÔ´Ï´Ù).
	     System.out.println("c1 =" +c1);
 ...
 * ¹®ÀÚ ÄÚµå°ªÀÌ ´Ù¸¨´Ï´Ù. ±¹Á¦È­ ÀÎÄÚµùÀ¸·Î utf-8 ¹æ½ÄÀ» ¸¹ÀÌ »ç¿ëÇÕ´Ï´Ù
