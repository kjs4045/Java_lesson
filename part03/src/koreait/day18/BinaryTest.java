...
public class BinaryTest {
	...
	/*
	 * 10진수 정수값을 다른 진법(진수)으로 문자열변환
	 * Integer.toBinaryString(i)		-> 2진수로 변환
	 * Integer.toHexString(i)			-> 8진수로 변환
	 * Integer.toOctalString(i)			-> 16진수로 변환
	 * 
	 * int 형식은 4바이트 32비트 2진수는 32자리, 16진수로는 8자리, 10진수로는 값 범위 -2147483648 ~ 247483647
	 ...
	 * 1000	0000 0000 0000 0000 0000 0000 0000 는 -21477483648
